...
fn en_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("cuda.installed", "NVIDIA acceleration is installed. It starts being used the next time Vesper opens."),
...
fn pt_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("cuda.installed", "Aceleração NVIDIA instalada. Ela passa a ser usada na próxima vez que o Vesper abrir."),
