...
fn en_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("download.done", "Done"),
        ("download.retrying", "Retrying {attempt}/{max} · resuming at {at}"),
        ...
        ("confirm.delete_body", "The transcript, the summary, the chat and the audio recording are all deleted from this computer. This cannot be undone."),
...
fn pt_dict() -> HashMap<&'static str, &'static str> {
    HashMap::from([
        ...
        ("download.retrying", "Tentativa {attempt}/{max} · retomando em {at}"),
        ...
        ("confirm.delete_body", "A transcrição, o resumo, o chat e a gravação de áudio são apagados deste computador. Não dá para desfazer."),
